...
<body>
    <div class="fluid-container">
                ...
                <div class="login" id="log">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                Nếu chưa có tài khoản bấm <a href="./pages/register.html">tại đây</a> để đăng ký!
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="icon row">
                            ...
                            <div class="login-box card" id="loginBox">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>
                                        Nếu chưa có tài khoản bấm <a href="./pages/register.html">tại đây</a> để đăng
                                        ký!
                                    </p>
                                </div>
                            </div>
        ...
        <!-- slide -->
        <div style="margin-top: 100px;" id="carouselExampleIndicators" class="carousel slide">
